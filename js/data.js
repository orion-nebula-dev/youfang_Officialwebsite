// 全站内容与素材的单一数据源。
// - 内容口径：品牌、导航、小程序、三阶段、模拟经营方案、信息公开入口。
...
const SITE_DATA = {
  ...
  assets: {
    ...
    // 品牌门店方向照片（品牌卡 / 画廊）
    'photo-guxiaotui': localAsset('photo/brand-gu-xiaotui.jpg', '归档/原始素材/门店装修效果图', '谷小推门店视觉'),
    'photo-aixiaowan': localAsset('photo/brand-ai-xiaowan.jpg', '归档/原始素材/门店装修效果图', '艾小晚门店视觉'),
    'photo-zukangshu': localAsset('photo/brand-zu-kang-shu.jpg', '归档/原始素材/门店装修效果图', '足康树门店视觉'),
    'photo-hengqingshu': localAsset('photo/brand-heng-qing-shu.jpg', '归档/原始素材/门店装修效果图', '恒青树门店视觉'),
    'photo-leguangli': localAsset('photo/brand-le-guangli.jpg', '归档/原始素材/门店装修效果图', '乐光里门店视觉'),
    'photo-naiwan': localAsset('photo/brand-naiwan.jpg', '归档/原始素材/门店装修效果图', '奈晚推拿门店视觉'),
    'photo-shisixun': localAsset('photo/brand-shisixun.jpg', '归档/原始素材/门店装修效果图', '廿肆巡门店视觉'),
    // 门店效果图（装修方案渲染）
    ...
    'store-guxiaotui-real-2': localAsset('photo/store-gu-xiaotui-real-2.jpg', '归档/原始素材/集团介绍-提取', '谷小推门店现场'),
    'store-guxiaotui-real-3': localAsset('photo/store-gu-xiaotui-real-3.jpg', '归档/原始素材/集团介绍-提取', '谷小推门店项目墙'),
    'store-hengqingshu-real': localAsset('photo/store-heng-qing-shu-real.jpg', '归档/原始素材/灵枢发布-预览', '恒青树门店实拍'),
    'store-hengqingshu-real-2': localAsset('photo/store-heng-qing-shu-real-2.jpg', '归档/原始素材/集团介绍-提取', '恒青树门店门头'),
    'store-hengqingshu-real-3': localAsset('photo/store-heng-qing-shu-real-3.jpg', '归档/原始素材/集团介绍-提取', '恒青树门店现场一'),
    'store-hengqingshu-real-4': localAsset('photo/store-heng-qing-shu-real-4.jpg', '归档/原始素材/集团介绍-提取', '恒青树门店现场二'),
    'store-hengqingshu-real-5': localAsset('photo/store-heng-qing-shu-real-5.jpg', '归档/原始素材/集团介绍-提取', '恒青树门店现场三'),
    'store-hengqingshu-real-6': localAsset('photo/store-heng-qing-shu-real-6.jpg', '归档/原始素材/集团介绍-提取', '恒青树门店现场四'),
    'store-naiwan-real': localAsset('photo/store-naiwan-real.jpg', '归档/原始素材/灵枢发布-预览', '奈晚推拿门店实拍'),
    'store-naiwan-real-2': localAsset('photo/store-naiwan-real-2.jpg', '归档/原始素材/集团介绍-提取', '奈晚推拿门店现场'),
  ...
  brands: [
    {
      ...
      image: 'photo-guxiaotui', logo: 'logo-guxiaotui', logoVertical: 'logo-guxiaotui-v', screen: 'screen-guyoufang-guxiaotui', accent: 'orange', tagline: '服务空间与体验表达',
    ...
    },
    {
      ...
      image: 'photo-aixiaowan', logo: 'logo-aixiaowan', logoVertical: 'logo-aixiaowan-v', screen: 'screen-guyoufang-aixiaowan', accent: 'red', tagline: '家门口的健康服务',
    ...
    },
    {
      ...
      image: 'photo-leguangli', logo: 'logo-leguangli', logoVertical: 'logo-leguangli-v', screen: 'screen-guyoufang-leguangli', accent: 'orange', tagline: '用空间创造放松感',
    ...
    },
    {
      ...
      storeForms: [{ logo: 'logo-naiwan-care', label: '调理店' }, { logo: 'logo-naiwan-relax', label: '舒缓店' }, { logo: 'logo-naiwan-x', label: '奈晚X' }], screen: 'screen-guyoufang-naiwan', accent: 'red', tagline: '更细致的日常照护',
    ...
    },
    {
      ...
      image: 'photo-shisixun', logo: 'logo-shisixun', logoVertical: 'logo-shisixun-v', screen: 'screen-guyoufang-shisixun', accent: 'ghost', tagline: '城市门店与经营协同方向',
  ...
  simPlans: {
    ...
    experience: { title: '空间体验服务方案', summary: '先从门店空间和到店感受出发，把品牌表达、服务节奏和现场体验连成一条路径。', brands: ['谷小推', '乐光里'], points: ['先确认空间表达与服务节奏', '把门店动线和岗位动作拆开训练', '用真实服务现场持续复盘体验问题'] },
    family: { title: '家庭与长者服务方案', summary: '先从家庭、长者和社区关系出发，重点关注服务理解、团队协同和长期关系维护。', brands: ['恒青树', '奈晚推拿'], points: ['先梳理家庭与长者的真实需求', '建立稳定、清晰的服务流程', '通过社区反馈持续调整服务内容'] },
    city: { title: '城市生活服务方案', summary: '先从城市生活场景出发，把门店表达、服务入口和经营协同放在同一张计划里。', brands: ['廿肆巡'], points: ['先明确城市场景和门店服务对象', '梳理空间、团队和服务入口的关系', '用阶段复盘保持经营动作清晰'] },
  },
  simPhases: { learn: '先了解品牌和经营场景', location: '先沟通城市、位置和店型', opening: '先确认开业训练和筹备节点', operate: '先整理门店问题和运营反馈' },
  // 门店实拍二级页（mdzs/<slug>.html）：文案均为《集团介绍》PDF 原文，
  // photos 为素材注册表 ID；caption 只写 OCR/材料可确认的内容。
  storeGallery: {
    guxiaotui: {
      ...
      photos: [
        ...
        { id: 'store-guxiaotui-real-2', caption: '门店现场' },
        { id: 'store-guxiaotui-real-3', caption: '店内「小推 · 新中式 SPA」标识与精油调理项目墙' },
      ],
    },
    hengqingshu: {
      ...
      photos: [
        { id: 'store-hengqingshu-real', caption: '社区生活俱乐部店内活动现场' },
        { id: 'store-hengqingshu-real-2', caption: '「恒青树｜社区生活俱乐部」门头与新客服务价目' },
        { id: 'store-hengqingshu-real-3', caption: '店内现场一' },
        { id: 'store-hengqingshu-real-4', caption: '店内现场二' },
        { id: 'store-hengqingshu-real-5', caption: '店内现场三' },
        { id: 'store-hengqingshu-real-6', caption: '店内现场四' },
      ],
    },
    naiwan: {
      ...
      photos: [
        ...
        { id: 'store-naiwan-real-2', caption: '门店现场' },
